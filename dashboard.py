...
# import requests
# import config
# from macrotrends import income_statement




# ticker = st.text_input("Enter Symbol", value="AAPL")
...
# #all_earnings['EPS'] = all_earnings['EPS'].astype(float) # convert EPS to float to be able to do calculations
